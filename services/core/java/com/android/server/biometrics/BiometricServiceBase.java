...
public abstract class BiometricServiceBase extends SystemService
    ...
    private static final int MSG_POWER_KEY_DOWN = 11;
    ...
    protected final boolean mHasPowerButtonFingerprint;
    ...
    protected void handleAuthenticated(boolean authenticated,
        ...
        if (client != null && isKeyguard(mCurrentClient.getOwnerString())
                && mWindowManagerPolicy != null && authenticated && mHasPowerButtonFingerprint) {
